package com.winchampion.model.response.dwdGqrdData;
...
@Schema(name = "dwd_gqrd_data数据对象")
public class DwdGqrdDataResult {
    ...
    @Schema(name = "fillno", description = "填报号")
    ...
    @Schema(name = "registrtime", description = "注册时间")
    ...
    @Schema(name = "technologyno", description = "科技人员")
    ...
    @Schema(name = "year1", description = "年度")
    ...
    @Schema(name = "exportearnings", description = "出口创汇额（美元）")
    private String exportearnings;


    @Schema(name = "incometax", description = "应交所得税")
    private String incometax;


    @Schema(name = "reducetax", description = "享受高新技术企业减免所得税")
    private String reducetax;
    ...
    @Schema(name = "rdcodesinchina", description = "在中国境内研发费用总额（万元）")
    private String rdcodesinchina;
    ...
    @Schema(name = "lmobile", description = "联系电话")
    private String lmobile;


    @Schema(name = "lemail", description = "电邮（企业法定代表人）")
    ...
    @Schema(name = "technologynoper", description = "技术人员占职工总数百分比")
    private String technologynoper;
    ...
    @Schema(name = "totalinvestment", description = "总投资额")
    private String totalinvestment;


    @Schema(name = "investmenthome", description = "中方投资额")
    private String investmenthome;


    @Schema(name = "investmenthomeper", description = "中方投资额占比")
    private String investmenthomeper;


    @Schema(name = "investmentout", description = "外方投资额")
    private String investmentout;
    ...
    public String getExportearnings() {
        return exportearnings;
    }

    public void setExportearnings(String exportearnings) {
    ...
    public String getReducetax() {
        return reducetax;
    }

    public void setReducetax(String reducetax) {
    ...
    public String getRdcodesinchina() {
        return rdcodesinchina;
    }

    public void setRdcodesinchina(String rdcodesinchina) {
        this.rdcodesinchina = rdcodesinchina;
    }
    ...
    public String getTechnologynoper() {
        return technologynoper;
    }

    public void setTechnologynoper(String technologynoper) {
        this.technologynoper = technologynoper;
    }
    ...
    public String getInvestmenthome() {
        return investmenthome;
    }

    public void setInvestmenthome(String investmenthome) {
        this.investmenthome = investmenthome;
    }

    public String getInvestmenthomeper() {
        return investmenthomeper;
    }

    public void setInvestmenthomeper(String investmenthomeper) {
        this.investmenthomeper = investmenthomeper;
    }

    public String getInvestmentout() {
        return investmentout;
    }

    public void setInvestmentout(String investmentout) {
        this.investmentout = investmentout;
    }
