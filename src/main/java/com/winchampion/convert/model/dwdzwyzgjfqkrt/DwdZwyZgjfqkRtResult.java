package com.winchampion.model.response.dwdzwyzgjfqkrt;
...
@Schema(name = "dwd_zwy_zgjfqk_rt数据对象")
public class DwdZwyZgjfqkRtResult {
    ...
    @Schema(name = "rtjnje", description = "养老金缴纳金额")
    private String rtjnje;
    ...
    public String getRtjnje() {
        return rtjnje;
    }

    public void setRtjnje(String rtjnje) {
        this.rtjnje = rtjnje;
    }
